    ...
    return `
      ...
      <html>
        ...
        <head>
          ...
          <meta http-equiv="Content-Security-Policy" content="default-src 'self';frame-src https://giphy.com/; connect-src ${appConfig.apiBaseUrl}; img-src * 'self' data: vscode-resource: https:; script-src  vscode-resource: https://unpkg.com/ 'nonce-${nonce}'; style-src vscode-resource: https://unpkg.com/ 'unsafe-inline';" />
